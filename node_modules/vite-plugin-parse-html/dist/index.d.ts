 ...
 * @description
 */
type InjectHtmlPosition = 'head' | 'body' | 'head-prepend' | 'body-prepend';
/**
...
export { InjectOptions, MinifyOptions, PluginOptions, SourceItem, _default as default, injectHtml as inject, minifyHtmlPlugin as minify };
